...
% TODO: what features do you leave out
...
\subsection{Failure of Traditional Binary Classifiers} % 0.5 - 1 page
1. Logistic Regression.

2. Simple matrix factorization. latent topic model 

\subsection{Nearest Neighbour Classifier} % 0.5-1 page
feature-based nearest neighbour model. behavior-based nearest neighbour model
not available.

\subsection{One-class learning solver (SVM)} % 0.5-1 page
